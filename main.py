...
if "output" in st.session_state:
    ...
    # MODIFIED: Apply post-processing to the problem statement
    safe_display(post_process_llm_text(st.session_state.auto_goal, unit))
    ...
    # MODIFIED: Apply post-processing to the problem statement
    problem_statement = post_process_llm_text(problem_statement, unit)
